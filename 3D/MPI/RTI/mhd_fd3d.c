...
#pragma omp single
	...
	double *pc[]={cx,cy,cz};
	boundary(pc,3,nx,ny,nz,xoff,yoff,zoff,stx,&dnxs[4],sty,&dnys[4],stz,&dnzs[4],gamma,phi_g,mpi_rank,mpi_numx,mpi_numy,mpi_numz);
      }
...
#pragma omp single
	...
	boundary(pv,3,nx,ny,nz,xoff,yoff,zoff,stx,dnx,sty,dny,stz,dnz,gamma,phi_g,mpi_rank,mpi_numx,mpi_numy,mpi_numz);
      }
...
#pragma simd
    ...
    /* Boundary condition */
    boundary(p,nm,nx,ny,nz,xoff,yoff,zoff,stxs,dnxs,stys,dnys,stzs,dnzs,gamma,phi_g,mpi_rank,mpi_numx,mpi_numy,mpi_numz);
  }
