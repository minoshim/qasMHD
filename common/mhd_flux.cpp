...
void rsst_flux_hlld(double rol, double vnl, double vtl, double vul, double btl, double bul, double prl, double ixil,
		    double ror, double vnr, double vtr, double vur, double btr, double bur, double prr, double ixir,
		    double bnc, double gamma, const double *dv,
		    double *fro, double *fmn, double *fmt, double *fmu, double *fbt, double *fbu, double *fen)
/* Calculate HLLD fluxes with RSST */
/* rol,vnl,vtl,vul,btl,bul,prl: input primitive variables at the left side */
// ixil is RSST factor (1/\xi) at the left side
/* ror,vnr,vtr,vur,btr,bur,prr: input primitive variables at the right side */
// ixir is RSST factor (1/\xi) at the right side
/* bnc: input normal magnetic field at the interface */
/* gamma: specific heat ratio */
/* fro,fmn,fmt,fmu,fbt,fbu,fen: output HLLD fluxes at the interface*/
...
{
  // RSST factor
  double ixi_face=max(ixil,ixir);
  double ixi_f2=min(ixi_face*ixi_face,1.0);
...
void rsst_flux_lhlld(double rol, double vnl, double vtl, double vul, double btl, double bul, double prl, double ixil,
		     double ror, double vnr, double vtr, double vur, double btr, double bur, double prr, double ixir,
		     double bnc, double gamma, const double *dv,
		     double *fro, double *fmn, double *fmt, double *fmu, double *fbt, double *fbu, double *fen)
/* Calculate low-dissipation HLLD fluxes (quasi-all-speed extension) with RSST */
/* rol,vnl,vtl,vul,btl,bul,prl: input primitive variables at the left side */
// ixil is RSST factor (1/\xi) at the left side
/* ror,vnr,vtr,vur,btr,bur,prr: input primitive variables at the right side */
// ixir is RSST factor (1/\xi) at the right side
