...
The instability is essentially incompressible phenomenon, and conventional shock-capturing schemes fail to resolve the low-Mach KHI due to excess numerical diffusion.<br>
