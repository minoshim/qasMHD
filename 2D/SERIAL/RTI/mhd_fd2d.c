...
#pragma omp single
	...
	double *pc[]={cx,cy};
	boundary(pc,2,nx,ny,xoff,yoff,stx,&dnxs[4],sty,&dnys[4],gamma,phi_g);
      }
...
#pragma omp single
	...
	double *pv[]={dvx,dvy};
	boundary(pv,2,nx,ny,xoff,yoff,stx,dnx,sty,dny,gamma,phi_g);
      }
...
#pragma simd
    ...
    /* Boundary condition */
    boundary(p,nm,nx,ny,xoff,yoff,stxs,dnxs,stys,dnys,gamma,phi_g);
  }
